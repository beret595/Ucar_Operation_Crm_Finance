<%@ Page language="c#" Codebehind="ViwCustomer.aspx.cs" AutoEventWireup="false" Inherits="casey.hxyd_crm.Web.UI.ViwCustomer" %>
					...
					<td colSpan="6">
						<table width="100%">
							...
							<tr>
								...
								<td class="bg_column"><FONT face="宋体"></FONT></td>
								<td class="bg_data"></td>
